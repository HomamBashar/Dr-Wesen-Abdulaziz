...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAFBFC] dark:bg-ink-950 flex flex-col">
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl font-bold text-[#1F2937] dark:text-ink-50">عيادة الدكتورة وسن عبدالعزيز رشيد لطب العيون</h1>
            <p className="text-sm text-slate-500 dark:text-ink-400 mt-1">د. وسن عبدالعزيز رشيد</p>
          </div>

          <form onSubmit={handleSubmit} className="bg-white dark:bg-ink-900 rounded-2xl border border-slate-200 dark:border-ink-700 p-8 space-y-6">
            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-ink-200 mb-3 text-center">
                أدخل رمز الدخول
              </label>
              <Input
            ...
            <p className="text-xs text-slate-400 dark:text-ink-500 text-center">
      ...
      <footer className="py-4 text-center text-xs text-slate-400 dark:text-ink-500">
